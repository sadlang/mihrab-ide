...
BUNDLE_MARKERS = [
    ...
    # لم يعد له مشهودٌ عليه. وموضعُ الشريط/المسطرة اليومَ يُحسَب في TS لا في CSS، فالشاهدُ
    # اسمُ الخيار الذي يحمله — اسمُ خاصّيّةٍ في كائنٍ حرفيّ، ينجو من التصغير (عُدَّ: 7).
    # وهو نفسُه المخرجُ الموثَّق إن أُريد ردُّ الشريط يمينًا (راجع patches/README.md).
    ("محرّر: جانبُ الشريط العموديّ خيارًا (م-٢)", JS, "verticalScrollbarSide", 1),
    ...
    *[(f"CSS [هويّة]: {cls}", CSS, cls, 1) for cls in M.IDENTITY_CLASSES],
    ...
    # القاعدة 37 [SC-01]: الأشكالُ السياقيّة في صندوق رسالة الالتزام. القاعدةُ **مقيسةٌ
    # حيًّا** (‏scm_input.live.mjs) لا مفترَضة: حقنُ الخاصّيّة يغيّر القيمةَ المحسوبة فعلًا.
    ("CSS37: أشكال صندوق الالتزام السياقيّة [SC-01]", CSS,
     "[dir=rtl] .scm-view .scm-editor-container .monaco-editor .view-line", 1),
