...
try {
  ...
  ok(msgs.some(m => m.includes("لم أجد إعدادًا")),
    "رسالةُ «لم أجد إعدادًا يسبّب الإطارات» على حالةٍ نظيفة", JSON.stringify(msgs));
  ...
  msgs = await toasts(cdp);
  ok(msgs.some(m => m.includes("تمّ —") && m.includes("nonBasicASCII")),
